          ...
          <div className="flex flex-col justify-center items-center pt-36 pb-20 px-4">
            <div className="w-[500px] relative  max-w-[100%] rounded-sm ">
              <div className="space-y-[32px]">
                <div className="max-w-fit mx-auto max-w-fit mx-auto relative before:content-[''] before:absolute before:block before:h-full before:w-full before:bg-[#2DB473] before:blur-[36px]"><img src="/payment-successful-icon.svg" alt="Payment-icon" className="relative z-1"/></div>
