...
import { addBankDetails, GetBankDetails, viewProfile } from "@/app/utils/api";
          ...
          <div className="flex justify-center items-start pt-36 pb-20 px-4">
            {loading ? (
              ...
              <div className="w-[850px] max-w-[100%] bg-brandBlack rounded-sm p-[30px]">
                <h2 className="md:text-[23px] text-center text-text-lg leading-[36px] font-semibold text-white mb-[27px]">
