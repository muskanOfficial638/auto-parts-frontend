        ...
        <div className="container flex items-center justify-between">
          ...
          {!autoPartsUserData ? (
            <div className="hidden lg:flex items-center space-x-[22px] text-[17px]  font-semibold leading-[15px] text-white">
              <Link href="/login" className="hover:text-hoverblue duration-400">
                Login
              </Link>
              <Link href="/sign-up" className="hover:text-hoverblue duration-400">
                Sign Up
              </Link>
              <button
        ...
        <div className="flex flex-col px-6 space-y-6 mt-4 text-lg">
          ...
          {!autoPartsUserData ? (
            <>
              ...
              <Link href="/sign-up" className="hover:text-hoverblue">
                Sign Up
              </Link>
              <button
                onClick={() => toast.error("Please login to your account!")}
